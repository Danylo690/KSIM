...
to go
  ...
  ask patches with [ pcolor = red ] [
    ...
    ;; if fire already extinguishing set patch free
    ;; otherwise default work
  ...
  ;; decrease rain time and time to next rain
  if rain-time != 0 [
